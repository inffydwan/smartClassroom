...
static FRESULT miscellaneous(void)
{
  ...
  res_flash = f_open(&fnew, "1:FatFs读写测试文件.txt",
    ...
    if (res_flash == FR_OK)
    {
      ...
      f_printf(&fnew,"\n在原来文件新添加一行内容uuuuuuuuuuuuuuuuuuuuuuuuuuuuuiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiuuuuuuuuuu\n");
